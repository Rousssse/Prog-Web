<template>
  <div class="div-content">
    <div class="matches" :class="{ selected: selected }">
      ...
      <img
        class="image_opponent0"
        v-bind:src="theGame.opponents[0].opponent.image_url"
      />
      ...
      <img
        class="image_opponent1"
        v-bind:src="theGame.opponents[1].opponent.image_url"
      />
    </div>
